...
homekit_characteristic_t toggle = HOMEKIT_CHARACTERISTIC_(PROGRAMMABLE_SWITCH_EVENT, 0);

void toggle_callback(uint8_t gpio_num) {
    homekit_characteristic_notify(&toggle, HOMEKIT_UINT8(0));
}
    ...
    {HOMEKIT_ACCESSORY(
             ...
             .services =
                 (homekit_service_t *[]){
                     ...
                     HOMEKIT_SERVICE(
                         STATELESS_PROGRAMMABLE_SWITCH, .primary = false,
                         .characteristics =
                             (homekit_characteristic_t *[]){
